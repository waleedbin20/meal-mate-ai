      ...
      <div className="min-h-screen flex w-full bg-gradient-to-br from-[#F6F6F7] to-[#F2FCE2]">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            {/* FAQ Section */}
            <div className="bg-white rounded-lg p-8 shadow-lg animate-[fade-in_0.6s_ease-out_0.9s] opacity-0 [animation-fill-mode:forwards]">
              <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Frequently Asked Questions</h2>
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger>What is the Quote Management System?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger>How do I create a new quote?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger>Can I modify a quote after creation?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-4">
                  <AccordionTrigger>How are labor costs calculated?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-5">
                  <AccordionTrigger>Need technical support?</AccordionTrigger>
                  <AccordionContent>
