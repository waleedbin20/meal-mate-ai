        ...
        <main className="flex-1 p-4 md:p-8">
          ...
          <div className="max-w-4xl mx-auto space-y-8 md:space-y-16">
            ...
            <div className="text-center space-y-6 md:space-y-8 px-4">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#1A1F2C] to-[#403E43] bg-clip-text text-transparent 
                [text-shadow:_0_0_30px_rgb(139_92_246_/_0.3)] animate-pulse">
                Quote Management System
              </h1>
              <p className="text-lg md:text-xl text-[#403E43] animate-[fade-in_0.6s_ease-out_0.3s] opacity-0 [animation-fill-mode:forwards]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-[fade-in_0.6s_ease-out_0.6s] opacity-0 [animation-fill-mode:forwards]">
                <Button 
                  ...
                  size="lg"
                  className="text-base md:text-lg px-6 md:px-8 py-6 bg-[#1A1F2C] hover:bg-[#403E43] text-white
                ...
                <Button 
                  ...
                  size="lg"
                  variant="outline"
                  className="text-base md:text-lg px-6 md:px-8 py-6 border-2 border-[#1A1F2C] text-[#1A1F2C] hover:bg-[#F1F0FB] hover:text-[#403E43]
                    transform transition-all duration-300 hover:scale-105 hover:shadow-xl w-full sm:w-auto"
                >
                  View Saved Quotes
                </Button>
            ...
            {/* FAQ Section */}
            <div className="bg-white/90 backdrop-blur-sm rounded-lg p-4 md:p-8 shadow-lg animate-[fade-in_0.6s_ease-out_0.9s] opacity-0 [animation-fill-mode:forwards] mx-4 md:mx-0">
              <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 md:mb-8 text-[#1A1F2C]">Frequently Asked Questions</h2>
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1" className="border-[#E5DEFF]">
                  <AccordionTrigger className="text-[#1A1F2C] hover:text-[#403E43] text-left">
