                                                ...
                                                >
                                                        ...
                                                        <div className="flex items-start justify-between">
                                                            ...
                                                            <div className="flex gap-2">
                                                                ...
                                                                <Button
                                                                    variant="ghost"
                                                                    size="sm"
                                                                    className="group-hover:opacity-100 transition-opacity text-red-600 hover:text-red-700 hover:bg-red-50"
                                                    ...
                                                    <CardContent>
                                                        <div className="flex items-center justify-between text-sm">
                                                            ...
                                                            <span
                                                                className={`px-2 py-1 rounded-full text-xs font-medium ${quote.quoteStatus.toLowerCase() === "approved"
